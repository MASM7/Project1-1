...
void assembler(const char *inputFile, const char *outputFile) {
    ...
    while (fgets(line, sizeof(line), fp) != NULL) {
        ...
        // Remove spaces from the line for uniform comparison
        char command[50];
        int j = 0;
        ...
        command[j] = '\0';  // Null-terminate the command string
        ...
        // Handle immediate values for RA, RB, JC, J using switch cases for each command type
